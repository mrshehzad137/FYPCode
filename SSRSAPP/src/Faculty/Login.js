...
export default class FacultyLoginView extends Component {
  ...
  onClickListener = (viewId) => {
    ...
    fetch("http://192.168.8.100:4000/api/faculty/signin",{
      method: 'POST',
      headers: {
    ...
    .then((json) => {
      ...
      saveData("isReviewer",json.Userdata.isReviewer.toString());
      saveData("isSupervisor",json.Userdata.isSupervisor.toString());
    ...
    return (
      <View style={styles.container}>
        <View style={styles.imagecontainer}>
          <Image source={require('../assets/img/Faculty.png')} style={{width:200,height:200}}/>
        </View>
